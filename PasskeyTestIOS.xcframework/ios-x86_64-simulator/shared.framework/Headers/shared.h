...
@class UIWindow, SharedCreatePasskeyResultError, SharedCreatePasskeyResultSuccess, SharedFetchPasskeyPublicKey, SharedFetchPasskeyCompanion, SharedFetchPasskey, SharedFetchPasskeyPublicKeyCompanion, SharedPasskeyCreationPublicKey, SharedPasskeyCreationCompanion, SharedPasskeyCreation, SharedPasskeyCreationPublicKeyRp, SharedPasskeyCreationPublicKeyUser, SharedPasskeyCreationPublicKeyPubKeyCredParams, SharedPasskeyCreationPublicKeyAuthenticatorSelection, SharedPasskeyCreationPublicKeyCompanion, SharedPasskeyCreationPublicKeyAuthenticatorSelectionCompanion, SharedPasskeyCreationPublicKeyPubKeyCredParamsCompanion, SharedPasskeyCreationPublicKeyRpCompanion, SharedPasskeyCreationPublicKeyUserCompanion, SharedKotlinByteIterator, SharedKotlinByteArray, NSData, SharedKotlinThrowable, SharedKotlinArray<T>, SharedKotlinException, SharedKotlinRuntimeException, SharedKotlinIllegalStateException, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;

@protocol SharedPlatform, SharedCreatePasskeyResult, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinIterator, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinAnnotation, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedKotlinKClass, SharedKotlinKDeclarationContainer, SharedKotlinKAnnotatedElement, SharedKotlinKClassifier;
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TwilioPasskey")))
@interface SharedTwilioPasskey : SharedBase
- (instancetype)initWithUiWindow:(UIWindow *)uiWindow relyingPartyIdentifier:(NSString *)relyingPartyIdentifier __attribute__((swift_name("init(uiWindow:relyingPartyIdentifier:)"))) __attribute__((objc_designated_initializer));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)createPasskeyChallengePayload:(NSString *)challengePayload result:(void (^)(id<SharedCreatePasskeyResult>))result completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("createPasskey(challengePayload:result:completionHandler:)")));

/**
 * @note This method converts instances of CancellationException to errors.
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)displayPasskeysChallengePayload:(NSString *)challengePayload completionHandler:(void (^)(NSError * _Nullable))completionHandler __attribute__((swift_name("displayPasskeys(challengePayload:completionHandler:)")));
@end

__attribute__((swift_name("CreatePasskeyResult")))
@protocol SharedCreatePasskeyResult
@required
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CreatePasskeyResultError")))
@interface SharedCreatePasskeyResultError : SharedBase <SharedCreatePasskeyResult>
- (instancetype)initWithErrorCode:(int32_t)errorCode errorDescription:(NSString * _Nullable)errorDescription __attribute__((swift_name("init(errorCode:errorDescription:)"))) __attribute__((objc_designated_initializer));
- (SharedCreatePasskeyResultError *)doCopyErrorCode:(int32_t)errorCode errorDescription:(NSString * _Nullable)errorDescription __attribute__((swift_name("doCopy(errorCode:errorDescription:)")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("CreatePasskeyResultSuccess")))
@interface SharedCreatePasskeyResultSuccess : SharedBase <SharedCreatePasskeyResult>
- (instancetype)initWithAsd:(NSString *)asd __attribute__((swift_name("init(asd:)"))) __attribute__((objc_designated_initializer));
- (SharedCreatePasskeyResultSuccess *)doCopyAsd:(NSString *)asd __attribute__((swift_name("doCopy(asd:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString *asd __attribute__((swift_name("asd")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FetchPasskey")))
@interface SharedFetchPasskey : SharedBase
- (instancetype)initWithPublicKey:(SharedFetchPasskeyPublicKey *)publicKey __attribute__((swift_name("init(publicKey:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedFetchPasskeyCompanion *companion __attribute__((swift_name("companion")));
- (SharedFetchPasskey *)doCopyPublicKey:(SharedFetchPasskeyPublicKey *)publicKey __attribute__((swift_name("doCopy(publicKey:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedFetchPasskeyPublicKey *publicKey __attribute__((swift_name("publicKey")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FetchPasskey.Companion")))
@interface SharedFetchPasskeyCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedFetchPasskeyCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FetchPasskeyPublicKey")))
@interface SharedFetchPasskeyPublicKey : SharedBase
- (instancetype)initWithChallenge:(NSString *)challenge timeout:(int64_t)timeout rpId:(NSString *)rpId userVerification:(NSString *)userVerification __attribute__((swift_name("init(challenge:timeout:rpId:userVerification:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedFetchPasskeyPublicKeyCompanion *companion __attribute__((swift_name("companion")));
- (SharedFetchPasskeyPublicKey *)doCopyChallenge:(NSString *)challenge timeout:(int64_t)timeout rpId:(NSString *)rpId userVerification:(NSString *)userVerification __attribute__((swift_name("doCopy(challenge:timeout:rpId:userVerification:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property NSString *challenge __attribute__((swift_name("challenge")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("FetchPasskeyPublicKey.Companion")))
@interface SharedFetchPasskeyPublicKeyCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedFetchPasskeyPublicKeyCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreation")))
@interface SharedPasskeyCreation : SharedBase
- (instancetype)initWithPublicKey:(SharedPasskeyCreationPublicKey *)publicKey __attribute__((swift_name("init(publicKey:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPasskeyCreationCompanion *companion __attribute__((swift_name("companion")));
- (SharedPasskeyCreation *)doCopyPublicKey:(SharedPasskeyCreationPublicKey *)publicKey __attribute__((swift_name("doCopy(publicKey:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) SharedPasskeyCreationPublicKey *publicKey __attribute__((swift_name("publicKey")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreation.Companion")))
@interface SharedPasskeyCreationCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPasskeyCreationCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey")))
@interface SharedPasskeyCreationPublicKey : SharedBase
- (instancetype)initWithChallenge:(NSString *)challenge rp:(SharedPasskeyCreationPublicKeyRp *)rp user:(SharedPasskeyCreationPublicKeyUser *)user pubKeyCredParams:(NSArray<SharedPasskeyCreationPublicKeyPubKeyCredParams *> *)pubKeyCredParams timeout:(int64_t)timeout attestation:(NSString * _Nullable)attestation excludeCredentials:(NSArray<id> * _Nullable)excludeCredentials authenticatorSelection:(SharedPasskeyCreationPublicKeyAuthenticatorSelection *)authenticatorSelection __attribute__((swift_name("init(challenge:rp:user:pubKeyCredParams:timeout:attestation:excludeCredentials:authenticatorSelection:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPasskeyCreationPublicKeyCompanion *companion __attribute__((swift_name("companion")));
- (SharedPasskeyCreationPublicKey *)doCopyChallenge:(NSString *)challenge rp:(SharedPasskeyCreationPublicKeyRp *)rp user:(SharedPasskeyCreationPublicKeyUser *)user pubKeyCredParams:(NSArray<SharedPasskeyCreationPublicKeyPubKeyCredParams *> *)pubKeyCredParams timeout:(int64_t)timeout attestation:(NSString * _Nullable)attestation excludeCredentials:(NSArray<id> * _Nullable)excludeCredentials authenticatorSelection:(SharedPasskeyCreationPublicKeyAuthenticatorSelection *)authenticatorSelection __attribute__((swift_name("doCopy(challenge:rp:user:pubKeyCredParams:timeout:attestation:excludeCredentials:authenticatorSelection:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable attestation __attribute__((swift_name("attestation")));
@property (readonly) SharedPasskeyCreationPublicKeyAuthenticatorSelection *authenticatorSelection __attribute__((swift_name("authenticatorSelection")));
@property NSString *challenge __attribute__((swift_name("challenge")));
@property (readonly) NSArray<id> * _Nullable excludeCredentials __attribute__((swift_name("excludeCredentials")));
@property (readonly) NSArray<SharedPasskeyCreationPublicKeyPubKeyCredParams *> *pubKeyCredParams __attribute__((swift_name("pubKeyCredParams")));
@property (readonly) SharedPasskeyCreationPublicKeyRp *rp __attribute__((swift_name("rp")));
@property (readonly) int64_t timeout __attribute__((swift_name("timeout")));
@property (readonly) SharedPasskeyCreationPublicKeyUser *user __attribute__((swift_name("user")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.AuthenticatorSelection")))
@interface SharedPasskeyCreationPublicKeyAuthenticatorSelection : SharedBase
- (instancetype)initWithAuthenticatorAttachment:(NSString * _Nullable)authenticatorAttachment requireResidentKey:(SharedBoolean * _Nullable)requireResidentKey residentKey:(NSString * _Nullable)residentKey userVerification:(NSString * _Nullable)userVerification __attribute__((swift_name("init(authenticatorAttachment:requireResidentKey:residentKey:userVerification:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPasskeyCreationPublicKeyAuthenticatorSelectionCompanion *companion __attribute__((swift_name("companion")));
- (SharedPasskeyCreationPublicKeyAuthenticatorSelection *)doCopyAuthenticatorAttachment:(NSString * _Nullable)authenticatorAttachment requireResidentKey:(SharedBoolean * _Nullable)requireResidentKey residentKey:(NSString * _Nullable)residentKey userVerification:(NSString * _Nullable)userVerification __attribute__((swift_name("doCopy(authenticatorAttachment:requireResidentKey:residentKey:userVerification:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable authenticatorAttachment __attribute__((swift_name("authenticatorAttachment")));
@property (readonly) SharedBoolean * _Nullable requireResidentKey __attribute__((swift_name("requireResidentKey")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.AuthenticatorSelectionCompanion")))
@interface SharedPasskeyCreationPublicKeyAuthenticatorSelectionCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPasskeyCreationPublicKeyAuthenticatorSelectionCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.Companion")))
@interface SharedPasskeyCreationPublicKeyCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPasskeyCreationPublicKeyCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.PubKeyCredParams")))
@interface SharedPasskeyCreationPublicKeyPubKeyCredParams : SharedBase
- (instancetype)initWithType:(NSString *)type alg:(int32_t)alg __attribute__((swift_name("init(type:alg:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPasskeyCreationPublicKeyPubKeyCredParamsCompanion *companion __attribute__((swift_name("companion")));
- (SharedPasskeyCreationPublicKeyPubKeyCredParams *)doCopyType:(NSString *)type alg:(int32_t)alg __attribute__((swift_name("doCopy(type:alg:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.PubKeyCredParamsCompanion")))
@interface SharedPasskeyCreationPublicKeyPubKeyCredParamsCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPasskeyCreationPublicKeyPubKeyCredParamsCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.Rp")))
@interface SharedPasskeyCreationPublicKeyRp : SharedBase
- (instancetype)initWithName:(NSString *)name id:(NSString *)id icon:(NSString * _Nullable)icon __attribute__((swift_name("init(name:id:icon:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPasskeyCreationPublicKeyRpCompanion *companion __attribute__((swift_name("companion")));
- (SharedPasskeyCreationPublicKeyRp *)doCopyName:(NSString *)name id:(NSString *)id icon:(NSString * _Nullable)icon __attribute__((swift_name("doCopy(name:id:icon:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.RpCompanion")))
@interface SharedPasskeyCreationPublicKeyRpCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPasskeyCreationPublicKeyRpCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.User")))
@interface SharedPasskeyCreationPublicKeyUser : SharedBase
- (instancetype)initWithId:(NSString *)id icon:(NSString * _Nullable)icon name:(NSString *)name displayName:(NSString *)displayName __attribute__((swift_name("init(id:icon:name:displayName:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPasskeyCreationPublicKeyUserCompanion *companion __attribute__((swift_name("companion")));
- (SharedPasskeyCreationPublicKeyUser *)doCopyId:(NSString *)id icon:(NSString * _Nullable)icon name:(NSString *)name displayName:(NSString *)displayName __attribute__((swift_name("doCopy(id:icon:name:displayName:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyCreationPublicKey.UserCompanion")))
@interface SharedPasskeyCreationPublicKeyUserCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPasskeyCreationPublicKeyUserCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
- (NSString *)b64Encode __attribute__((swift_name("b64Encode()")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PasskeyPayloadMapperKt")))
@interface SharedPasskeyPayloadMapperKt : SharedBase
+ (SharedKotlinByteArray *)b64Decode:(NSString *)receiver __attribute__((swift_name("b64Decode(_:)")));
@end
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("TwilioPasskeyKt")))
@interface SharedTwilioPasskeyKt : SharedBase
