...
class AuthorizationControllerWrapperMock : IAuthorizationControllerWrapper {
  ...
  override fun createPasskey(
    ...
    completion(CreatePasskeyResult.Error(TwilioException.GeneralException(Exception("Unable to find a createPasskeyResultValue"))))
  }
  ...
  override fun authenticatePasskey(
    ...
    completion(AuthenticatePasskeyResult.Error(TwilioException.GeneralException(Exception("Unable to find a authenticatePasskeyResultValue"))))
  }
}
