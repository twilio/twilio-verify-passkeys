...
| **`InvalidPayloadException`**     | 1008  | Thrown when the JSON payload is invalid, meaning the data does not meet the expected format or schema.                                                                                                                                                                                                          | N/A                                                                                                                                                                                                                                      |
| **`GeneralException`**            | 1009  | Represents a general or unspecified error used as a fallback for errors not fitting other categories.                                                                                                                                                                                                           | N/A                                                                                                                                                                                                                                      |
